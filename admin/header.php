...
$modPathIcon16   = \WGBLOCKS_URL . '/' . $GLOBALS['xoopsModule']->getInfo('modicons16') . '/';
$modPathIcon32   = \WGBLOCKS_URL . '/' . $GLOBALS['xoopsModule']->getInfo('modicons32') . '/';
...
$style = \WGBLOCKS_URL . '/assets/css/admin/style.css';
